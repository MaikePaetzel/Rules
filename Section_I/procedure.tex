...
\begin{itemize}
\item The referee \added{randomly} chooses the goal at which the kicks will be taken
\item The referee \added{randomly chooses a team to perform the first penalty kick} \removed{tosses a coin and the team whose captain wins the toss decides whether to take the first or the second kick}
...
\item \removed{A goalkeeper who is injured while kicks are being taken from the penalty mark and is unable to continue as goalkeeper may be replaced by a named substitute provided his team has not used the maximum number of substitutes permitted under the competition rules}
\item \removed{With the exception of the foregoing case,
      only players who are on the field of play at the end of the match,
      which includes extra time where appropriate,
      (new) or which are serving their 30 second penalty time or are currently in service,
...
\item \removed{An eligible player may change places with the goalkeeper at any time when kicks from the penalty mark are being taken}
\item \removed{Only the eligible players and match officials are permitted to remain on the field of play when kicks from the penalty mark are being taken}
\item \greyed{suspended: The goalkeeper who is the team-mate of the kicker must
...
\item \greyed{suspended: The goalkeeper who is the team-mate of the kicker must
      ...
      outside the penalty area in which the kicks are being taken,
...
\item ... touched the ball \removed{more often} \added{in more of the performed trials}. If this is a tie:
