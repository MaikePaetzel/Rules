...
{\bfseries January 11, 2021}
\end{center}

\begin{figure}[!h]
\centering
\includegraphics[height=3.5in]{img/nimbro_robot.jpg}
\captionsetup{labelformat=empty}
\caption{Team NimbRo, winner of the Best Humanoid Award 2019}
\end{figure}

{\large Changes to the original rule book are either \added{marked in magenta text colour} (for additions) or by  \removed{crossed out text} (for deletions).}
...
\added{Virtual} RoboCup Humanoid League Competition Rules}
\end{center}
